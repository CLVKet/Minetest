...
local function get_formspec(tabview, name, tabdata)
    ...
    if core.setting_get("versiontype") == "lite" then
        retval = retval ..
             "button[4,4.7;2.8,0.5;full_version;".. fgettext("More Games") .. "]" ..
             "button[1,3.8;2.8,0.5;removeads;".. fgettext("Remove Ads") .. "]" ..
             "button[1,4.7;2.8,0.5;restoreiap;".. fgettext("Restore IAP") .. "]"
    end
	return retval
end
...
local function main_button_handler(this, fields, name, tabdata)
    ...
    if fields["removeads"] ~= nil then
        core.removeads()
        return true
    end

    if fields["restoreiap"] ~= nil then
            core.restoreiap()
            return true
     end
